...
if type_plot == 'numDen':
    ...
    dataL = np.load('/Users/dear-prudence/Desktop/snapshots_lmc/snapshot_' + snap + '/'
                    '09_18_gas_massDen_lmc_snap' + snap + '_200x200x25ckpc_bin0.25ckpc_0_1.npz')
    dataR = np.load('/Users/dear-prudence/Desktop/snapshots_lmc/snapshot_' + snap + '/'
                    '09_18_gas_massDen_lmc_snap' + snap + '_25x200x200ckpc_bin0.25ckpc_2_1.npz')
    v_min = 1
    v_max = 1e6
    c_map = 'viridis'
...
if type_plot == 'vlsr':
    im1 = ax1.imshow(imageL, origin='lower', extent=[x_edgesL[0], x_edgesL[-1], y_edgesL[0], y_edgesL[-1]],
                     cmap=c_map, vmin=v_min, vmax=v_max)
    im2 = ax2.imshow(imageR, origin='lower', extent=[x_edgesR[0], x_edgesR[-1], y_edgesR[0], y_edgesR[-1]],
                     cmap=c_map, vmin=v_min, vmax=v_max)
else:
    im1 = ax1.imshow(imageL, origin='lower', extent=[x_edgesL[0], x_edgesL[-1], y_edgesL[0], y_edgesL[-1]],
...
filename = ('/Users/dear-prudence/Desktop/snapshots_lmc/snapshot_' + snap
            + '/09_18_gas_massDen_lmc_snap' + snap + '_25x200ckpc.png')
